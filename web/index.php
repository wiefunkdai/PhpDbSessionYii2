...
define('YII_ENV', 'dev');
define('SDAILOVER_VENDORPATH', dirname(__DIR__) . '/vendor');
define('SDAILOVER_YIIPATH', SDAILOVER_VENDORPATH . '/yiisoft');
define('SDAILOVER_PATH', dirname(__DIR__));

require SDAILOVER_PATH . '/SDaiLover.php';

$config = require SDAILOVER_PATH . '/config/web.php';
SDaiLover::createWebApplication($config)->run();